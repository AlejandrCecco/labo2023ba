...
ksemilla_azar <- 110689 # cambiar por la primer semilla
...
dir.create("~/exp/HT3210_2/", showWarnings = FALSE)
...
dir.create("~/buckets/b1/exp/HT3210_2/", showWarnings = FALSE)

# copio los archivos
system( "cp -r ~/exp/HT3210_2/*  ~/buckets/b1/exp/HT3210_2" )
