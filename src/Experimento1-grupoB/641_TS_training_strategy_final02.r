# Experimentos Colaborativos Default - Experimento 1 - GRUPO B
...
PARAM$exp_input <- "FE6310_final02"
...
202002, 202001, 201912 , 201911, 201910, 201909, 202108
)
PARAM$train$training <- c( 
  202101, 202012, 202011, 202010,
    202009, 202008, 202002, 202001, 201912, 201911, 201910, 
...
PARAM$train$semilla <- 110689 # cambiar por su propia semilla  !!!
