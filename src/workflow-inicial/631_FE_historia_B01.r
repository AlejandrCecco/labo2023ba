...
PARAM <- list()
PARAM$experimento <- "FE6310_B01"

PARAM$exp_input <- "DR6210_B01"
...
PARAM$RandomForest$semilla <- 110689 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 121075
...
CanaritosAsesinos <- function(
    canaritos_ratio = 0.2,
    canaritos_desvios = 3.0, canaritos_semilla = 121075) {
  gc()
  dataset[, clase01 := ifelse(clase_ternaria == "CONTINUA", 0, 1)]
