...
PARAM <- list()
PARAM$experimento <- "TS6410_B01"

PARAM$exp_input <- "FE6310_B01"
...
202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 202106, 202105
)
